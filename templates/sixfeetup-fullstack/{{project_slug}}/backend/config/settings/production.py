...
CSRF_TRUSTED_ORIGINS = env.list(
    ...
    default=["http://localhost", "https://{{ domain_name }}"],
)
# DATABASES
# ------------------------------------------------------------------------------
...
# STATIC
# ------------------------
STATICFILES_STORAGE = "{{ project_slug }}.utils.cloud_storage.S3StaticStorage"
STATIC_URL = f"https://{AWS_STORAGE_BUCKET_NAME}.s3.amazonaws.com/static/"

# MEDIA
# ------------------------------------------------------------------------------
DEFAULT_FILE_STORAGE = "{{ project_slug }}.utils.cloud_storage.S3MediaStorage"
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="{{ project_name }} <noreply@{{ domain_name }}>",
)
